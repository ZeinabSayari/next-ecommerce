...
const handleQuantity =(type:"i"| "d")=>{
    ...
    return(<div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between">
          ...
          <div className="bg-gray-100 py-2 px-4 rounded-3xl flex ite justify-between w-32" >
        ...
        <button  className="w-36 text-sm rounded-3xl ring-1
         ring-redColor py-2 px-4 hover:bg-redColor hover:text-white
          disabled:cursor-not-allowed disabled:bg-pink-200 disabled:text-white disabled:ring-none">Add to Cart</button>
       </div>
    </div>)
