...
const NavIcon = ()=>{
    ...
    return (<div className="flex items-center justify-center gap-4 xl:gap-6 relative">
        ...
        onClick={cartHandler}
        />
        <div className="absolute  -top-4 -right-4 w-6 h-6 bg-redColor rounded-full text-white text-sm flex items-center justify-center">2</div>
        </div>
        {isCartOpen && (
            <CartModal/>
        )}
